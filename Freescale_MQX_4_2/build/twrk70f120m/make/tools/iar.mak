...
# common settings
AS_FLAGS += --cpu Cortex-M4F --fpu VFPv4_sp -s -M'<>' -w+ -r -j -S 
CC_FLAGS += --cpu=Cortex-M4F --fpu=VFPv4_sp --diag_suppress Pa082,Pe186 --no_cse --no_unroll --no_inline --no_code_motion --no_tbaa --no_clustering --no_scheduling --endian=little -e --use_c++_inline --silent --vla --debug 
CX_FLAGS += --cpu=Cortex-M4F --fpu=VFPv4_sp --diag_suppress Pa082,Pe186 --no_cse --no_unroll --no_code_motion --no_tbaa --no_clustering --no_scheduling --endian=little -e --c++ --silent --debug 
