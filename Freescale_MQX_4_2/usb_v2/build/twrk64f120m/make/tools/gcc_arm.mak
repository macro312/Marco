...
# common settings
AS_FLAGS += -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -std=gnu99 -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf -x assembler-with-cpp 
CC_FLAGS += -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -std=gnu99 -nostdinc -ffunction-sections -fdata-sections -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf -fno-strict-aliasing -Wno-unused-value -Wno-missing-braces -Wno-unused-variable -Wno-unused-but-set-variable -Wno-pointer-to-int-cast -Wno-unused-function -Wno-unused-label -Wno-switch -Wno-implicit-function-declaration 
CX_FLAGS += -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=fpv4-sp-d16 -nostdinc -nostdinc++ -fno-exceptions -ffunction-sections -fdata-sections -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf -fno-strict-aliasing -Wno-unused-value -Wno-missing-braces -Wno-unused-variable -Wno-unused-but-set-variable -Wno-pointer-to-int-cast -Wno-unused-function -Wno-unused-label -Wno-switch -Wno-implicit-function-declaration 
...
CC_DEFINE += _AEABI_LC_CTYPE=C __STRICT_ANSI__=1 CPU_MK64FN1M012=1 CPU_MK64FN1M0VMD12=1 
