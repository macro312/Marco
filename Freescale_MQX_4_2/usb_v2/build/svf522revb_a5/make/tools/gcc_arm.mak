...
# common settings
AS_FLAGS += -mcpu=cortex-a5 -mfloat-abi=hard -mfpu=neon-vfpv4 -mthumb-interwork -std=gnu99 -Wall -g2 -gdwarf-2 -gstrict-dwarf -x assembler-with-cpp 
CC_FLAGS += -mcpu=cortex-a5 -mfloat-abi=hard -mfpu=neon-vfpv4 -std=gnu99 -nostdinc -ffunction-sections -fdata-sections -Wall -mthumb -mthumb-interwork -g2 -gdwarf-2 -gstrict-dwarf -fno-strict-aliasing -fno-strict-aliasing -Wno-unused-value -Wno-missing-braces -Wno-unused-variable -Wno-unused-but-set-variable -Wno-pointer-to-int-cast -Wno-unused-function -Wno-unused-label -Wno-switch -Wno-implicit-function-declaration 
...
CC_DEFINE += _AEABI_LC_CTYPE=C __STRICT_ANSI__=1 CPU_SVF522R3K_A5=1 
