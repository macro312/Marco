...
#----------------------------------------------------------
ifneq ($(MAKECMDGOALS),)
BOARD_LIST := $(dir $(wildcard $(USB_ROOTDIR)/build/*/make/))
BOARD_LIST := $(subst $(USB_ROOTDIR)/build/,,$(BOARD_LIST))
...
$(error "BOARD [$(BOARD)] is not supported by USB Unify Stack, use one of : $(BOARD_LIST) ")
endif
endif
...
#----------------------------------------------------------
ifneq ($(MAKECMDGOALS),)
TOOL_LIST := $(wildcard $(USB_ROOTDIR)/build/$(BOARD)/make/tools/*.mak)
...
$(error "TOOL [$(TOOL)] is not supported by USB Unify Stack, use one of : $(TOOL_LIST) ")
endif
endif
