...
# common settings
AS_FLAGS += -mcpu=cortex-m4 -mfloat-abi=hard -mfpu=vfpv4 -std=gnu99 -Wall -mthumb -g2 -gdwarf-2 -gstrict-dwarf -x assembler-with-cpp 
...
CC_DEFINE += _AEABI_LC_CTYPE=C __STRICT_ANSI__=1 CPU_SVF522R3K_M4=1 
