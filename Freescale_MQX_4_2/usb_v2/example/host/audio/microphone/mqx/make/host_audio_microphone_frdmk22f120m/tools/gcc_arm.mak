...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
LIBRARIES += $(USB_ROOTDIR)/output/frdmk22f120m.gcc_arm/debug/usbh/mqx/libusbh_mqx.a
...
LIBRARIES += $(USB_ROOTDIR)/../lib/frdmk22f120m.gcc_arm/debug/mfs/mfs.a
LIBRARIES += $(USB_ROOTDIR)/../lib/frdmk22f120m.gcc_arm/debug/shell/shell.a
endif
ifeq ($(CONFIG),release)
LIBRARIES += $(USB_ROOTDIR)/output/frdmk22f120m.gcc_arm/release/usbh/mqx/libusbh_mqx.a
...
LIBRARIES += $(USB_ROOTDIR)/../lib/frdmk22f120m.gcc_arm/release/mfs/mfs.a
LIBRARIES += $(USB_ROOTDIR)/../lib/frdmk22f120m.gcc_arm/release/shell/shell.a
endif
...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
INCLUDE += $(USB_ROOTDIR)/output/frdmk22f120m.gcc_arm/debug/usbh/mqx
...
INCLUDE += $(USB_ROOTDIR)/../lib/frdmk22f120m.gcc_arm/debug/mfs
INCLUDE += $(USB_ROOTDIR)/../lib/frdmk22f120m.gcc_arm/debug/shell
endif
ifeq ($(CONFIG),release)
INCLUDE += $(USB_ROOTDIR)/output/frdmk22f120m.gcc_arm/release/usbh/mqx
...
INCLUDE += $(USB_ROOTDIR)/../lib/frdmk22f120m.gcc_arm/release/mfs
INCLUDE += $(USB_ROOTDIR)/../lib/frdmk22f120m.gcc_arm/release/shell
endif
