...
LIBRARIES += $(USB_ROOTDIR)/../lib/svf522revb_a5.gcc_arm/debug/mfs/mfs.a
LIBRARIES += $(USB_ROOTDIR)/../lib/svf522revb_a5.gcc_arm/debug/shell/shell.a
endif
ifeq ($(CONFIG),release)
...
LIBRARIES += $(USB_ROOTDIR)/../lib/svf522revb_a5.gcc_arm/release/mfs/mfs.a
LIBRARIES += $(USB_ROOTDIR)/../lib/svf522revb_a5.gcc_arm/release/shell/shell.a
endif
...
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_a5.gcc_arm/debug/mfs
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_a5.gcc_arm/debug/shell
endif
ifeq ($(CONFIG),release)
...
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_a5.gcc_arm/release/mfs
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_a5.gcc_arm/release/shell
endif
