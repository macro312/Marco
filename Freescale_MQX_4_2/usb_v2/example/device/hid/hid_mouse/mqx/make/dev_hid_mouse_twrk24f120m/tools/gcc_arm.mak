...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
LIBRARIES += $(USB_ROOTDIR)/output/twrk24f120m.gcc_arm/debug/usbd/mqx/libusbd_mqx.a
...
ifeq ($(CONFIG),release)
LIBRARIES += $(USB_ROOTDIR)/output/twrk24f120m.gcc_arm/release/usbd/mqx/libusbd_mqx.a
...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
INCLUDE += $(USB_ROOTDIR)/output/twrk24f120m.gcc_arm/debug/usbd/mqx
...
ifeq ($(CONFIG),release)
INCLUDE += $(USB_ROOTDIR)/output/twrk24f120m.gcc_arm/release/usbd/mqx
