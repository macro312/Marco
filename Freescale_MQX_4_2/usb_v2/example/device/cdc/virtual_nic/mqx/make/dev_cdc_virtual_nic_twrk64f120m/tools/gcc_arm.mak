...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
LIBRARIES += $(USB_ROOTDIR)/output/twrk64f120m.gcc_arm/debug/usbd/mqx/libusbd_mqx.a
...
ifeq ($(CONFIG),release)
LIBRARIES += $(USB_ROOTDIR)/output/twrk64f120m.gcc_arm/release/usbd/mqx/libusbd_mqx.a
...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
INCLUDE += $(USB_ROOTDIR)/output/twrk64f120m.gcc_arm/debug/usbd/mqx
...
INCLUDE += $(USB_ROOTDIR)/../lib/twrk64f120m.gcc_arm/debug/rtcs
INCLUDE += $(USB_ROOTDIR)/../lib/twrk64f120m.gcc_arm/debug/psp
endif
ifeq ($(CONFIG),release)
INCLUDE += $(USB_ROOTDIR)/output/twrk64f120m.gcc_arm/release/usbd/mqx
...
INCLUDE += $(USB_ROOTDIR)/../lib/twrk64f120m.gcc_arm/release/rtcs
