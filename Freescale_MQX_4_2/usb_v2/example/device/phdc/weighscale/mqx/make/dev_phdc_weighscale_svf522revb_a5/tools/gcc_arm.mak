...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
LIBRARIES += $(USB_ROOTDIR)/output/svf522revb_a5.gcc_arm/debug/usbd/mqx/libusbd_mqx.a
...
ifeq ($(CONFIG),release)
LIBRARIES += $(USB_ROOTDIR)/output/svf522revb_a5.gcc_arm/release/usbd/mqx/libusbd_mqx.a
...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
INCLUDE += $(USB_ROOTDIR)/output/svf522revb_a5.gcc_arm/debug/usbd/mqx
...
ifeq ($(CONFIG),release)
INCLUDE += $(USB_ROOTDIR)/output/svf522revb_a5.gcc_arm/release/usbd/mqx
