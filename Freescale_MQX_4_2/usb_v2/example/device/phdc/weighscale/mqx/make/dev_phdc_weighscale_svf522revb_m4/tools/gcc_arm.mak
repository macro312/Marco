...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
LIBRARIES += $(USB_ROOTDIR)/output/svf522revb_m4.gcc_arm/debug/usbd/mqx/libusbd_mqx.a
LIBRARIES += $(USB_ROOTDIR)/../lib/svf522revb_m4.gcc_arm/debug/bsp/bsp.a
LIBRARIES += $(USB_ROOTDIR)/../lib/svf522revb_m4.gcc_arm/debug/psp/psp.a
endif
ifeq ($(CONFIG),release)
...
#-----------------------------------------------------------
ifeq ($(CONFIG),debug)
INCLUDE += $(USB_ROOTDIR)/output/svf522revb_m4.gcc_arm/debug/usbd/mqx
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_m4.gcc_arm/debug/bsp/Generated_Code
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_m4.gcc_arm/debug/bsp/Sources
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_m4.gcc_arm/debug
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_m4.gcc_arm/debug/bsp
INCLUDE += $(USB_ROOTDIR)/../lib/svf522revb_m4.gcc_arm/debug/psp
endif
ifeq ($(CONFIG),release)
