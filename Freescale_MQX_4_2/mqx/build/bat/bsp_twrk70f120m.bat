...
copy "%ROOTDIR%\mqx\source\io\adc\kadc\adc_mk70.h" "%OUTPUTDIR%\adc_mk70.h" /Y
...
copy "%ROOTDIR%\config\twrk70f120m\user_config.h" "%OUTPUTDIR%\..\user_config.h" /Y
...
copy "%ROOTDIR%\mqx\source\io\enet\macnet\macnet_mk70.h" "%OUTPUTDIR%\macnet_mk70.h" /Y
...
copy "%ROOTDIR%\mqx\source\io\flashx\freescale\flash_mk70.h" "%OUTPUTDIR%\flash_mk70.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\bsp_cm.h" "%OUTPUTDIR%\bsp_cm.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\TSS_SystemSetup.h" "%OUTPUTDIR%\TSS_SystemSetup.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\init_lpm.h" "%OUTPUTDIR%\init_lpm.h" /Y
...
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\bsp.h" "%OUTPUTDIR%\bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\bsp_rev.h" "%OUTPUTDIR%\bsp_rev.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\PE_LDD.h" "%OUTPUTDIR%\Generated_Code\PE_LDD.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\PE_Types.h" "%OUTPUTDIR%\Generated_Code\PE_Types.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\twrk70f120m.h" "%OUTPUTDIR%\twrk70f120m.h" /Y
...
xcopy /s /e /y /h "%ROOTDIR%\mqx\build\cw10gcc\bsp_twrk70f120m\Generated_Code\*" "%OUTPUTDIR%\Generated_Code\*"
xcopy /s /e /y /h "%ROOTDIR%\mqx\build\cw10gcc\bsp_twrk70f120m\Sources\*" "%OUTPUTDIR%\Sources\*"
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\gcc_cw\intflash_sramdata.ld" "%OUTPUTDIR%\intflash_sramdata.ld" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\gcc_cw\intflash_ddrdata.ld" "%OUTPUTDIR%\intflash_ddrdata.ld" /Y
...
copy "%ROOTDIR%\mqx\source\io\usb\if_dev_khci.h" "%OUTPUTDIR%\if_dev_khci.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb\usb_bsp.h" "%OUTPUTDIR%\usb_bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\gcc_arm\intflash_sramdata.ld" "%OUTPUTDIR%\intflash_sramdata.ld" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\gcc_arm\intflash_ddrdata.ld" "%OUTPUTDIR%\intflash_ddrdata.ld" /Y
copy "%ROOTDIR%\mqx\source\io\hmi\TSS\lib_cw_gcc\libTSS_KXX_M4.a" "%OUTPUTDIR%\tss.a" /Y
goto end_script
...
copy "%ROOTDIR%\mqx\source\io\usb\if_dev_khci.h" "%OUTPUTDIR%\if_dev_khci.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb\usb_bsp.h" "%OUTPUTDIR%\usb_bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\uv4\intflash_sramdata.scf" "%OUTPUTDIR%\intflash_sramdata.scf" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\uv4\intflash_ddrdata.scf" "%OUTPUTDIR%\intflash_ddrdata.scf" /Y
...
copy "%ROOTDIR%\mqx\source\io\usb\if_dev_khci.h" "%OUTPUTDIR%\if_dev_khci.h" /Y
copy "%ROOTDIR%\mqx\source\io\usb\usb_bsp.h" "%OUTPUTDIR%\usb_bsp.h" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\iar\intflash_ddrdata.icf" "%OUTPUTDIR%\intflash_ddrdata.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\iar\intflash_sramdata.icf" "%OUTPUTDIR%\intflash_sramdata.icf" /Y
copy "%ROOTDIR%\mqx\source\bsp\twrk70f120m\iar\intram.icf" "%OUTPUTDIR%\intram.icf" /Y
