...
%MAP_COMMON = (
    ...
    ".text|KERNEL|DISPATCH|S_Dispatch|IPSUM&psp.a|psp_\\w+.a" => "MQX_TEXT,MQX_ROM",
    ...
    ".rodata&psp.a|psp_\\w+.a"           => "MQX_RODATA,MQX_ROM",
    ...
    ".data&psp.a|psp_\\w+.a"           => "MQX_RODATA,MQX_ROM,MQX_RAM",
...
#
    ...
    ".(text|rodata|data)&psp.a|psp_\\w+.a&mqx\\w*.o"                => "CORE_ROM",
    ".(data|bss|kernel_data)&mqx(_regabi)?(_d)?.a&mqx\\w*.o"        => "CORE_RAM",
    ".(data|bss|kernel_data)&psp.a|psp_\\w+.a&mqx\\w*.o"            => "CORE_RAM",
    ...
    # MQX 4.0
    "(.text|.rodata|.data|KERNEL|DISPATCH)&psp.a&(dispatch|sched)\\w*.o"    => "SCHED_ROM",
    ".(data|bss)&psp.a|psp_\\w+.a&(dispatch|sched)\\w*.o"                   => "SCHED_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&((task)|(inittask)|(stack\\w*)).o"       => "TASK_ROM",
    ".(data|bss)&psp.a&((task)|(inittask)|(stack\\w*)).o"               => "TASK_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&queue.o"                         => "QUEUE_ROM",
    ".(data|bss)&psp.a&queue.o"                                 => "QUEUE_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&time\\w*.o"                      => "TIME_ROM",
    ".(data|bss)&psp.a&time\\w*.o"                              => "TIME_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&taskq.o"                         => "TQ_ROM",
    ".(data|bss)&psp.a&taskq.o"                                 => "TQ_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&int\\w*.o"                       => "INT_ROM",
    ".(text|rodata|data)&psp.a&int_xcpt\\w*.o"                  => "INT_ROM",
    ".(data|bss)&psp.a&int\\w*.o"                               => "INT_RAM",
    ".(data|bss)&psp.a&int_xcpt\\w*.o"                          => "INT_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&lwmem.o"                         => "LWMEM_ROM",
    ".(data|bss)&psp.a&lwmem.o"                                 => "LWMEM_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&mem.o"                           => "MEM_ROM",
    ".(data|bss)&psp.a&mem.o"                                   => "MEM_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&lwsem.o"                         => "LWSEM_ROM",
    ".(data|bss)&psp.a&lwsem.o"                                 => "LWSEM_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&lwevent.o"                       => "LWEVENT_ROM",
    ".(data|bss)&psp.a&lwevent.o"                               => "LWEVENT_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&event.o"                         => "EVENT_ROM",
    ".(data|bss)&psp.a&event.o"                                 => "EVENT_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&klog.o"                          => "KLOG_ROM",
    ".(data|bss)&psp.a&klog.o"                                  => "KLOG_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&log.o"                           => "LOG_ROM",
    ".(data|bss)&psp.a&log.o"                                   => "LOG_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&lwlog.o"                         => "LWLOG_ROM",
    ".(data|bss)&psp.a&lwlog.o"                                 => "LWLOG_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&lwmsgq.o"                        => "LWMSG_ROM",
    ".(data|bss)&psp.a&lwmsgq.o"                                => "LWMSG_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&lwtimer.o"                       => "LWTIMER_ROM",
    ".(data|bss)&psp.a&lwtimer.o"                               => "LWTIMER_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&msg\\w*.o"                       => "MSG_ROM",
    ".(text|rodata|data)&psp.a&msgq\\w*.o"                      => "MSG_ROM",
    ".(text|rodata|data)&psp.a&msgpool\\w*.o"                   => "MSG_ROM",
    ".(data|bss)&psp.a&msg\\w*.o"                               => "MSG_RAM",
    ".(data|bss)&psp.a&msgq\\w*.o"                              => "MSG_RAM",
    ".(data|bss)&psp.a&msgpool\\w*.o"                           => "MSG_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&mutex.o"                         => "MUTEX_ROM",
    ".(data|bss)&psp.a&mutex.o"                                 => "MUTEX_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&name.o"                          => "NAME_ROM",
    ".(data|bss)&psp.a&name.o"                                  => "NAME_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&partition.o"                     => "PART_ROM",
    ".(data|bss)&psp.a&partition.o"                             => "PART_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&sem.o"                           => "SEM_ROM",
    ".(data|bss)&psp.a&sem.o"                                   => "SEM_RAM",
    ...
    ".(data|bss)&psp_\\w+.a&wa_\\w*.o"                          => "WDOG_RAM",
    # MQX 4.0
    ".(text|rodata|data)&psp.a&watchdog.o"                      => "WDOG_ROM",
    ".(data|bss)&psp.a&watchdog.o"                              => "WDOG_RAM",
    ...
    # MQX 4.0
    ".(text|rodata|data)&psp.a&idletask.o"                      => "IDLE_ROM",
    ".(data|bss)&psp.a&idletask.o"                              => "IDLE_RAM",

    # I/O
    ".(text|rodata|data)&mqx(_regabi)?(_d)?.a&io_\\w*.o"        => "IO_ROM",
    ".(text|rodata|data)&psp.a|psp_\\w+.a&io_\\w*.o"            => "IO_ROM",
    ".(data|bss)&mqx(_regabi)?(_d)?.a&io_\\w*.o"                => "IO_RAM",
    ".(data|bss)&psp.a|psp_\\w+.a&io_\\w*.o"                    => "IO_RAM",
    # MQX 4.0 ... covered above

    # MQX string
    ".(text|rodata|data)&mqx(_regabi)?(_d)?.a&str\\w*.o"        => "STRING_ROM",
    ".(text|rodata|data)&psp.a|psp_\\w+.a&str\\w*.o"            => "STRING_ROM",
    ".(data|bss)&mqx(_regabi)?(_d)?.a&str\\w*.o"                => "STRING_RAM",
    ".(data|bss)&psp.a|psp_\\w+.a&str\\w*.o"                    => "STRING_RAM",
    # MQX 4.0 ... covered above

    # TAD
    ".(text|rodata|data)&mqx(_regabi)?(_d)?.a&tad\\w*.o"        => "TAD_ROM",
    ".(text|rodata|data)&psp.a|psp_\\w+.a&tad\\w*.o"            => "TAD_ROM",
    ".(data|bss)&mqx(_regabi)?(_d)?.a&tad\\w*.o"                => "TAD_RAM",
    ".(data|bss)&psp.a|psp_\\w+.a&tad\\w*.o"                    => "TAD_RAM",
    # MQX 4.0 ... covered above

    # Timer MQX 4.0
    ".(text|rodata|data)&mqx(_regabi)?(_d)?.a&timer\\w*.o"      => "TIMER_ROM",
    ".(text|rodata|data)&psp.a|psp_\\w+.a&timer\\w*.o"          => "TIMER_ROM",
    ".(data|bss)&mqx(_regabi)?(_d)?.a&timer\\w*.o"              => "TIMER_RAM",
    ".(data|bss)&psp.a|psp_\\w+.a&timer\\w*.o"                  => "TIMER_RAM",

    # MPU support (kinetis only)
    ".(text|rodata|data)&psp.a|psp_\\w+.a&kinetis_mpu.o"        => "MPU_ROM",
    ".(data|bss)&psp.a|psp_\\w+.a&kinetis_mpu.o"                => "MPU_RAM",
    # MQX 4.0 ... covered above

    # Cache support
    ".(text|rodata|data)&psp.a|psp_\\w+.a&cache.o"                  => "CACHE_ROM",
    ".(data|bss)&psp.a|psp_\\w+.a&cache.o"                          => "CACHE_RAM",

    # PSP
    ".(text|rodata|data)&mqx(_regabi)?(_d)?.a&(psp_|mcf_)\\w*.o"    => "PSP_ROM",
    ".(text|rodata|data)&psp.a|psp_\\w+.a&(psp_|mcf_)\\w*.o"        => "PSP_ROM",
    ".(data|bss)&mqx(_regabi)?(_d)?.a&(psp_|mcf_)\\w*.o"            => "PSP_RAM",
    ".(data|bss)&psp.a|psp_\\w+.a&(psp_|mcf_)\\w*.o"                => "PSP_RAM",
);
...
(
    ...
    # RSI
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&rs\\w*.o"                       => "ENET_RSI_ROM",
    ".(text|rodata|data)&bsp.a|bsp_\\w+.a&rs\\w*.o"                                    => "ENET_RSI_ROM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&rs\\w*.o"                               => "ENET_RSI_RAM",
    ".(data|bss)&bsp.a|bsp_\\w+.a&rs\\w*.o"                                            => "ENET_RSI_RAM",

    # GS
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&gs_\\w*.o"                      => "ENET_GS_ROM",
    ".(text|rodata|data)&bsp.a|bsp_\\w+.a&gs_\\w*.o"                                   => "ENET_GS_ROM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&gs_\\w*.o"                              => "ENET_GS_RAM",
    ".(data|bss)&bsp.a|bsp_\\w+.a&gs_\\w*.o"                                           => "ENET_GS_RAM",

    # ATHEROS
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_init\\w*.o"                 => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_ioctl\\w*.o"                => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_stack_offload\\w*.o"        => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_txrx\\w*.o"                 => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_wmi_rx\\w*.o"               => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&bmi\\w*.o"                      => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_init\\w*.o"            => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_ioctl\\w*.o"           => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_stack_offload\\w*.o"   => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_stack_txrx\\w*.o"      => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_txrx\\w*.o"            => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_wmi_rx\\w*.o"          => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_driver_main\\w*.o"         => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_driver_netbuf\\w*.o"       => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_hw_api\\w*.o"              => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_diag\\w*.o"              => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_init\\w*.o"              => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_main\\w*.o"              => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_netbuf\\w*.o"            => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_txrx\\w*.o"              => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&htc\\w*.o"                      => "ENET_ATHEROS_ROM",
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&hw_api\\w*.o"                   => "ENET_ATHEROS_ROM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_init\\w*.o"                         => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_ioctl\\w*.o"                        => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_stack_offload\\w*.o"                => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_txrx\\w*.o"                         => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&api_wmi_rx\\w*.o"                       => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&bmi\\w*.o"                              => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_init\\w*.o"                    => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_ioctl\\w*.o"                   => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_stack_offload\\w*.o"           => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_stack_txrx\\w*.o"              => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_txrx\\w*.o"                    => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_api_wmi_rx\\w*.o"                  => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_driver_main\\w*.o"                 => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_driver_netbuf\\w*.o"               => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&cust_hw_api\\w*.o"                      => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_diag\\w*.o"                      => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_init\\w*.o"                      => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_main\\w*.o"                      => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_netbuf\\w*.o"                    => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&driver_txrx\\w*.o"                      => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&htc\\w*.o"                              => "ENET_ATHEROS_RAM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&hw_api\\w*.o"                           => "ENET_ATHEROS_RAM",
    ...
    # RTC, IRTC, KRTC, SRTC, QRTC
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&[ikqs]?rtc\\w*.?o?"      => "RTC_ROM",
    ".(text|rodata|data)&bsp.a|bsp_\\w+.a&[ikqs]?rtc\\w*.?o?"                   => "RTC_ROM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&[ikqs]?rtc\\w*.?o?"              => "RTC_RAM",
    ".(data|bss)&bsp.a|bsp_\\w+.a&[ikqs]?rtc\\w*.?o?"                           => "RTC_RAM",
    ...
    # NAND
    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&nandflash\\w*.?o?"       => "NAND_ROM",
    ".(text|rodata|data)&bsp.a|bsp_\\w+.a&nandflash\\w*.?o?"                    => "NAND_ROM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&nandflash\\w*.?o?"               => "NAND_RAM",
    ".(data|bss)&bsp.a|bsp_\\w+.a&nandflash\\w*.?o?"                            => "NAND_RAM",

    ".(text|rodata|data)&(twrmcf|twrmpc|m)5[124]\\w*.a&nfc(_|)\\w*.?o?"         => "NAND_ROM",
    ".(text|rodata|data)&bsp.a|bsp_\\w+.a&nfc(_|)\\w*.?o?"                      => "NAND_ROM",
    ".(data|bss)&(twrmcf|twrmpc|m)5[124]\\w*.a&nfc(_|)\\w*.?o?"                 => "NAND_RAM",
    ".(data|bss)&bsp.a|bsp_\\w+.a&nfc(_|)\\w*.?o?"                              => "NAND_RAM",
...
(
    ...
    ".(text|rodata|data)&mfs.a|mfs_\\w+.a&(mfs_create)\\w*.o"               => "MFS_CRE_ROM",
    ".(data|bss)&mfs(_regabi)?(_d)?.a&(mfs_create)\\w*.o"                   => "MFS_CRE_RAM",
    ".(data|bss)&mfs.a|mfs_\\w+.a&(mfs_create)\\w*.o"                       => "MFS_CRE_RAM",
    ...
    ".(text|rodata|data)&mfs.a|mfs_\\w+.a&(mfs_init)\\w*.o"                 => "MFS_INIT_ROM",
    ".(data|bss)&mfs(_regabi)?(_d)?.a&(mfs_init)\\w*.o"                     => "MFS_INIT_RAM",
    ".(data|bss)&mfs.a|mfs_\\w+.a&(mfs_init)\\w*.o"                         => "MFS_INIT_RAM",
...
(
    # HTTP server
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(httpsrv|httpsrv_supp|httpsrv_task|httpsrv_script|httpsrv_ws|httpsrv_ws_api|httpsrv_ws_plugin|rtcs_sha1|rtcs_ssl).o" => "RTCS_HTTPSRV_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(httpsrv|httpsrv_supp|httpsrv_task|httpsrv_script|httpsrv_ws|httpsrv_ws_api|httpsrv_ws_plugin|rtcs_sha1|rtcs_ssl).o"           => "RTCS_HTTPSRV_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(httpsrv|httpsrv_supp|httpsrv_task|httpsrv_script|httpsrv_ws|httpsrv_ws_api|httpsrv_ws_plugin|rtcs_sha1|rtcs_ssl).o" => "RTCS_HTTPSRV_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(httpsrv|httpsrv_supp|httpsrv_task|httpsrv_script|httpsrv_ws|httpsrv_ws_api|httpsrv_ws_plugin|rtcs_sha1|rtcs_ssl).o"           => "RTCS_HTTPSRV_RAM",
    ...
    # TELNETD
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(telnet|telnetio|telnetsrv|telnetsrv_supp|telnetsrv_task).o" => "RTCS_TELD_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(telnet|telnetio|telnetsrv|telnetsrv_supp|telnetsrv_task).o"           => "RTCS_TELD_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(telnet|telnetio|telnetsrv|telnetsrv_supp|telnetsrv_task).o" => "RTCS_TELD_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(telnet|telnetio|telnetsrv|telnetsrv_supp|telnetsrv_task).o"           => "RTCS_TELD_RAM",

    # ECHO
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(echosrv|echocln).o" => "RTCS_ECHO_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(echosrv|echocln).o"           => "RTCS_ECHO_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(echosrv|echocln).o" => "RTCS_ECHO_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(echosrv|echocln).o"           => "RTCS_ECHO_RAM",
    ...
    #TFTP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(tftpcln|tftpsrv_supp|tftpsrv_task|tftpsrv|tftputil).o" => "RTCS_TFTP_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(tftpcln|tftpsrv_supp|tftpsrv_task|tftpsrv|tftputil).o"           => "RTCS_TFTP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(tftpcln|tftpsrv_supp|tftpsrv_task|tftpsrv|tftputil).o" => "RTCS_TFTP_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(tftpcln|tftpsrv_supp|tftpsrv_task|tftpsrv|tftputil).o"           => "RTCS_TFTP_RAM",

    #SOCKET
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(sock|sock_close|sock_dgram|sock_options|sock_select|sock_stream|sock_util|sockio|soigmp).o" => "RTCS_SOCK_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(sock|sock_close|sock_dgram|sock_options|sock_select|sock_stream|sock_util|sockio|soigmp).o"           => "RTCS_SOCK_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(sock|sock_close|sock_dgram|sock_options|sock_select|sock_stream|sock_util|sockio|soigmp).o" => "RTCS_SOCK_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(sock|sock_close|sock_dgram|sock_options|sock_select|sock_stream|sock_util|sockio|soigmp).o"           => "RTCS_SOCK_RAM",

    #DNS
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(dnscln|getaddrinfo|getnameinfo|rtcs_hosts).o" => "RTCS_DNS_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(dnscln|getaddrinfo|getnameinfo|rtcs_hosts).o"           => "RTCS_DNS_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(dnscln|getaddrinfo|getnameinfo|rtcs_hosts).o" => "RTCS_DNS_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(dnscln|getaddrinfo|getnameinfo|rtcs_hosts).o"           => "RTCS_DNS_RAM",

    #RTCS
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|inet_ntop|inet_pton|rtcs|rtcs_if|rtcsdela|rtcsglob|rtcsinit|rtcsrand|rtcsdate|rtcsmsec|rtcsmsg|rtcspart|rtcssec|rtcstask|iftunnel|inet|rtcslog0|rtcslog1|rtcs_base64|rtcs_utf8).o" => "RTCS_RTCS4_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|inet_ntop|inet_pton|rtcs|rtcs_if|rtcsdela|rtcsglob|rtcsinit|rtcsrand|rtcsdate|rtcsmsec|rtcsmsg|rtcspart|rtcssec|rtcstask|iftunnel|inet|rtcslog0|rtcslog1|rtcs_base64|rtcs_utf8).o"           => "RTCS_RTCS4_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|inet_ntop|inet_pton|rtcs|rtcs_if|rtcsdela|rtcsglob|rtcsinit|rtcsrand|rtcsdate|rtcsmsec|rtcsmsg|rtcspart|rtcssec|rtcstask|iftunnel|inet|rtcslog0|rtcslog1|rtcs_base64|rtcs_utf8).o" => "RTCS_RTCS4_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(ifadd|ifbootp|ifdhcp|ifrem|ifppp|rtcscmd|inet_ntop|inet_pton|rtcs|rtcs_if|rtcsdela|rtcsglob|rtcsinit|rtcsrand|rtcsdate|rtcsmsec|rtcsmsg|rtcspart|rtcssec|rtcstask|iftunnel|inet|rtcslog0|rtcslog1|rtcs_base64|rtcs_utf8).o"           => "RTCS_RTCS4_RAM",
    ...
    #DHCP/BootP
    ".(text|rodata|data)&rtcs(_regabi)?(_d)?.a&(dhcpclnt|dhcputil|bootp|bootinit|bootcomm|dhcpcln6|dhcpcln6_fsm|dhcpcln6_task).o" => "RTCS_DHCP_ROM",
    ".(text|rodata|data)&rtcs.a|rtcs_\\w+.a&(dhcpclnt|dhcputil|bootp|bootinit|bootcomm|dhcpcln6|dhcpcln6_fsm|dhcpcln6_task).o"           => "RTCS_DHCP_ROM",
    ".(data|bss)&rtcs(_regabi)?(_d)?.a&(dhcpclnt|dhcputil|bootp|bootinit|bootcomm|dhcpcln6|dhcpcln6_fsm|dhcpcln6_task).o" => "RTCS_DHCP_RAM",
    ".(data|bss)&rtcs.a|rtcs_\\w+.a&(dhcpclnt|dhcputil|bootp|bootinit|bootcomm|dhcpcln6|dhcpcln6_fsm|dhcpcln6_task).o"           => "RTCS_DHCP_RAM",
...
(
    #
    ".(text|rodata|data)&cyassl(_regabi)?(_d)?.a&*.o" => "CYASSL_ROM,SSL_ROM",
    ".(text|rodata|data)&cyassl.a|cyassl_\\w+.a&*.o"           => "CYASSL_ROM,SSL_ROM",
    ".(data|bss)&cyassl(_regabi)?(_d)?.a&*.o" => "CYASSL_RAM,SSL_RAM",
    ".(data|bss)&cyassl.a|cyassl_\\w+.a&*.o"           => "CYASSL_RAM,SSL_RAM",
    
    #
    ".(text|rodata|data)&lib_mmcau(_regabi)?(_d)?.a&*.o" => "LIBMMCAU_ROM,SSL_ROM",
    ".(text|rodata|data)&lib_mmcau.a|lib_mmcau_\\w+.a&*.o"           => "LIBMMCAU_ROM,SSL_ROM",
    ".(data|bss)&lib_mmcau(_regabi)?(_d)?.a&*.o" => "LIBMMCAU_RAM,SSL_RAM",
    ".(data|bss)&lib_mmcau.a|lib_mmcau_\\w+.a&*.o"           => "LIBMMCAU_RAM,SSL_RAM",
);
...
@SSL_ROM_COMPONENTS =
(
    ":---\n### Detailed breakdown of SSL Code (ROM) ###",    
    "CYASSL_ROM",
    "LIBMMCAU_ROM",
);
...
@SSL_RAM_COMPONENTS =
(
    ":---\n### Detailed breakdown of SSL/TLS Global Data (RAM) ###",
    "CYASSL_RAM",
    "LIBMMCAU_RAM",
);
...
(
    ...
    "CACHE_ROM"    => "Cache Management Code",
    "CACHE_RAM"    => "Cache Management Global Data",
    ...
    "ENET_RSI_ROM"     => "Ethernet Redpine Wifi Driver Code",
    "ENET_RSI_RAM"     => "Ethernet Redpine Wifi Driver Global Data",
    "ENET_GS_ROM"     => "Ethernet GainSpan Wifi Driver Code",
    "ENET_GS_RAM"     => "Ethernet GainSpan Wifi Driver Global Data",
    "ENET_ATHEROS_ROM"     => "Ethernet Atheros Wifi Driver Code",
    "ENET_ATHEROS_RAM"     => "Ethernet Atheros Wifi Driver Global Data",
    ...
    "SSL_ROM"     => "SSL/TLS ROM",
    "SSL_RAM"     => "SSL/TLS RAM",
    "CYASSL_ROM"     => "CyaSSL ROM",
    "CYASSL_RAM"     => "CyaSSL Global Data",
    "LIBMMCAU_ROM"     => "MMCAU lib ROM",
    "LIBMMCAU_RAM"     => "MMCAU lib Global Data",
    ...
    "SSL_ROM_OTHER"  => "Other SSL/TLS Code",
    "SSL_RAM_OTHER"  => "Other SSL/TLS Global Data",
...
if($DUMP_ROM)
{
    ...
    push @THE_REPORT, @SSL_ROM_COMPONENTS   if $DUMP_SSL_COMPONENTS;
    push @THE_REPORT, @SSL_ROM_COMPONENTS2  if $DUMP_SSL_COMPONENTS;
...
if($DUMP_RAM)
{
    ...
    push @THE_REPORT, @SSL_RAM_COMPONENTS   if $DUMP_SSL_COMPONENTS;
    push @THE_REPORT, @SSL_RAM_COMPONENTS2  if $DUMP_SSL_COMPONENTS;
...
%MAP_COMMON = (%MAP_COMMON, %MAP_SSL)  if $DUMP_SSL_COMPONENTS;
...
#                    $zerosz_addr = $symsz ? "" : $addr;
        ...
        elsif($format eq "ds5")
        {
            # symbol info eg:
            # Base Addr    Size         Type   Attr      Idx    E Section Name        Object
            # 0x000092e8   0x0000003c   Code   RO         2695    i._time_delay       psp.a(ti_delay.o)
            # 0x0000a314   0x000000c0   Data   RO         2045  * .constdata          bsp.a(init_sci.o)
            # 0x1fff0050   0x00000004   Data   RW         2817    .data               bsp.a(adc_kadc.o)
            # 0x1fff01a4   0x00000024   Zero   RW         2906    .bss                bsp.a(adt_kpdb.o)
            $line =~ s/\.\ text/.text/; # section name with space would cause us real troubles
            next if $line !~ /^\s*(\w+)\s+0x(\w+)\s+(Code|Data|Zero)\s+(RO|RW)\s+(\d+)\s*\*?\s*(\S+)\s+([^(]+)(\((.+)\))?$/;
...
sub get_map
{
    ...
    return ("gcc_arm", %MAP_COMMON) if $fmt =~ /^gcc_arm/i;
    return ("uv4arm", %MAP_COMMON, %MAP_UV4ARM) if $fmt =~ /^uv4/i;
    return ("kds", %MAP_COMMON) if $fmt =~ /^atl/i;
    return ("ds5", %MAP_COMMON, %MAP_DS5ARM) if $fmt =~ /^ds5/i;
...
sub print_usage
{
    my $readme =
        ...
        "    ARM-DS5 Development Studion v5.11 or later (use -c ds5)\n".
        "    GNU Tools for ARM Embedded Processors version 4.8 - or later (use -c gcc_arm)\n".
        "\n".
        "Options:\n".
