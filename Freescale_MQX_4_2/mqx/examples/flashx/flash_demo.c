...
#include <string.h>
    ...
    #endif
#elif (MQX_ENABLE_HSRUN)
    #if (BSP_TWR_K22F120M || BSP_FRDM_K22F120M)
        #error This application requires MQX_ENABLE_HSRUN to be defined zero in user_config.h. Please recompile BSP with this option.
    #endif
#else
...
#if (BSP_TWR_K65F180M && MQX_ENABLE_HSRUN)
     #error This application requires MQX_ENABLE_HSRUN defined zero in user_config.h. Please recompile BSP with this option.
#endif
