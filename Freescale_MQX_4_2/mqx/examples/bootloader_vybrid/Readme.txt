...
4) Run applications on Vybrid loaded by this bootloader
    4.1) Build application images and setup boodloader and run it on Vybrid board 
        ...
        d) Set the boot pins for SD boot.
            In TWR board REVG, set the j22 with 1-2 on, 3-4 off, 5-6 on, 7-8 on, 9-10 off, 11-12 off.
            In SVF522 board REVB, set the sw8 with 6 and 7 on, sw9 with 4 on, sw10, sw11 all off. Short J14 1-2, and J15 2-3
