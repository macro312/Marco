...
4) Build application images and setup boodloader and run it on Vybrid board 
    ...
    d) Set the boot pins for qspi boot.
        In TWR board REVG, set the j22 with 1-2 on, 3-4 off, 5-6 off, 7-8 off, 9-10 off, 11-12 off.
        In SVF522 board REVB, set the sw8,sw9,sw10,sw11 all off. Short J14 1-2, and J15 2-3
