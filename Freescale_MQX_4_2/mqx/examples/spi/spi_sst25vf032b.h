...
#define SPI_MEMORY_WRITE_LATCH_STATUS           0x50
#define SPI_MEMORY_WRITE_STATUS                 0x01
#define SPI_MEMORY_WRITE_BYTE                   0x02
#define SPI_MEMORY_WRITE_DATA                   0xAD
#define SPI_MEMORY_READ_DATA                    0x03
#define SPI_MEMORY_READH_DATA                   0x0B        //high speed read, need to add 1 dummy byte
