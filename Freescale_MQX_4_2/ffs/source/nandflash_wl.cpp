...
{ /* Body */
    ...
    dev_ptr->CORE_NANDFLASH.INIT                    = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->INIT;
    dev_ptr->CORE_NANDFLASH.DEINIT                  = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->DEINIT;
    dev_ptr->CORE_NANDFLASH.CHIP_ERASE              = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->CHIP_ERASE;
    dev_ptr->CORE_NANDFLASH.BLOCK_ERASE             = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->BLOCK_ERASE;
    dev_ptr->CORE_NANDFLASH.PAGE_READ               = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->PAGE_READ;
    dev_ptr->CORE_NANDFLASH.PAGE_PROGRAM            = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->PAGE_PROGRAM;
    dev_ptr->CORE_NANDFLASH.WRITE_PROTECT           = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->WRITE_PROTECT;
    dev_ptr->CORE_NANDFLASH.IS_BLOCK_BAD            = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->IS_BLOCK_BAD;
    dev_ptr->CORE_NANDFLASH.MARK_BLOCK_AS_BAD       = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->MARK_BLOCK_AS_BAD;
    dev_ptr->CORE_NANDFLASH.IOCTL                   = init_ptr->CORE_NANDFLASH_INIT_PTR->DEVIF_INIT->IOCTL;
    ...
    dev_ptr->PHY_PAGE_READ_RAW                      = init_ptr->DEVIF_INIT->PHY_PAGE_READ_RAW;
    dev_ptr->PHY_PAGE_WRITE_RAW                     = init_ptr->DEVIF_INIT->PHY_PAGE_WRITE_RAW;
    dev_ptr->PAGE_READ_METADATA                     = init_ptr->DEVIF_INIT->PAGE_READ_METADATA;
    dev_ptr->PAGE_READ_WITH_METADATA                = init_ptr->DEVIF_INIT->PAGE_READ_WITH_METADATA;
    dev_ptr->PAGE_WRITE_WITH_METADATA               = init_ptr->DEVIF_INIT->PAGE_WRITE_WITH_METADATA;
