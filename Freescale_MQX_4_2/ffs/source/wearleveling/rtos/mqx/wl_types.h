...
**--------------------------------------------------------------*/
#ifndef assert	/* avoid assert redefinition from mqx */
#define _ASSERT_
#ifndef _ASSERT_
#define ASSERT(cond)
...
#if NANDWL_USE_DMA
#define _wl_mem_alloc_uncache(s)    _mem_alloc_align(s, 8)
#else
...
#if NANDWL_USE_DMA
#define _wl_mem_alloc(s)            _mem_alloc_system_align(s, 8)
#define _wl_mem_alloc_zero          _mem_alloc_system_zero
#define _wl_mem_alloc_uncache(s)    _mem_alloc_system_align(s, 8)
#else
