...
{ /* Body */
    ...
    void * error_ptr = NULL;
    error_ptr = error_ptr; /* disable unused variable warning */
...
#if NANDWL_USE_MEDIA_BUFFER_MANAGER_CACHE
    _mutatr_set_sched_protocol(&mutex_init, MUTEX_PRIO_INHERIT);
#endif
...
* Returned Value   : void
* Comments         :
*   This function shows report status of media buffer
*
*END*--------------------------------------------------------------------*/
