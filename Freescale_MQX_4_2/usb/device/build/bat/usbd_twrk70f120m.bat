...
copy "%ROOTDIR%\usb\device\source\include\khci\khci_dev_main.h" "%OUTPUTDIR%\khci_dev_main.h" /Y
copy "%ROOTDIR%\usb\host\source\host\khci\khci_prv.h" "%OUTPUTDIR%\khci_prv.h" /Y
